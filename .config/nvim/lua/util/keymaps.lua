...
local function index(self, key)
    ...
    local function map_fn(arg1, arg2, arg3)
        ...
        if type(arg1) == "string" and (type(arg2) == "string" or type(arg2) == "function") then
            opts = arg3
            assert(opts == nil or type(opts) == "table", "expect table as argument #3")
        elseif type(arg1) == "table" then
            opts, maps = arg2, arg1
            assert(opts == nil or type(opts) == "table", "expect table as argument #2")
        else
        ...
        if not maps then
            ...
            for mode in pairs(modes) do map(mode, arg1, arg2, opts) end
        else
            for lhs, rhs in pairs(maps) do
                ...
                for mode in pairs(modes) do map(mode, lhs, rhs, opts) end
            end
        end
    end
